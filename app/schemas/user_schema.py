...
class UserBase(BaseModel):
    ...
    role_id : int = Field(description="User Role",default=True)
    status_id : int = Field(description="User Status",default=True)
...
class UserPatch(BaseModel):
    ...
    role_id: Optional[int] = Field(description="User Role",default=True)
    status_id: Optional[int] = Field(description="User Status",default=True)
